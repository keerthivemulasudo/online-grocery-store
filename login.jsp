...
<title>Insert title here</title>
  <style>
        ...
        body {
            ...
            background-image: url("https://res.cloudinary.com/dtbnzgbg8/image/upload/v1732197599/loginimg_uui2xp.jpg"); /* Ensure the background image path is correct */
    ...
    <div class="signup-container">
        <h2>Login Foam</h2>
            ...
            <div class="input-group">
                ...
                <input type="email" id="email" name="email" required placeholder="Enter your username">
            </div>
